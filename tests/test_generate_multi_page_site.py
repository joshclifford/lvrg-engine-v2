...
def test_calls_generate_page_once_per_planned_page(monkeypatch, tmp_path):
    ...
    def fake_generate_page(intel, design, page, nav, notes="", r6=None, meter=None, photo_assets=None, prospect_id=""):
...
def test_files_written_with_planned_filenames(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(
        ...
        lambda intel, design, page, nav, notes="", r6=None, meter=None, photo_assets=None, prospect_id="": f"<html><body>{page['slug']}</body></html>",
    )
...
def test_one_failing_page_raises_and_nothing_deployed(monkeypatch, tmp_path):
    ...
    def failing_generate_page(intel, design, page, nav, notes="", r6=None, meter=None, photo_assets=None, prospect_id=""):
        calls.append(page["slug"])
        if page["slug"] == "about":
...
def test_chat_widget_and_base_href_injected_into_every_page(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(
        generator, "generate_page",
        lambda intel, design, page, nav, notes="", r6=None, meter=None, photo_assets=None, prospect_id="":
...
def test_pages_actually_overlap_in_wall_time(monkeypatch, tmp_path):
    ...
    def slow_generate_page(intel, design, page, nav, notes="", r6=None, meter=None, photo_assets=None, prospect_id=""):
        time.sleep(0.3)
        return f"<html><body>{page['slug']}</body></html>"
...
def test_concurrency_never_exceeds_the_configured_cap(monkeypatch, tmp_path):
    ...
    def tracked_generate_page(intel, design, page, nav, notes="", r6=None, meter=None, photo_assets=None, prospect_id=""):
